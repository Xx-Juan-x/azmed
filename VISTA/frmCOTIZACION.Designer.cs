...
namespace VISTA
{
    partial class frmCOTIZACION
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gbDATOS_COTIZACION.Controls.Add(this.lblPRECIO4);
            this.gbDATOS_COTIZACION.Controls.Add(this.txtPRECIO3);
            this.gbDATOS_COTIZACION.Controls.Add(this.lblPRECIO3);
            this.gbDATOS_COTIZACION.Controls.Add(this.txtPRECIO2);
            this.gbDATOS_COTIZACION.Controls.Add(this.lblPRECIO2);
            this.gbDATOS_COTIZACION.Controls.Add(this.txtPRECIO1);
            this.gbDATOS_COTIZACION.Controls.Add(this.lblPRECIO1);
