...
namespace CONTROLADORA
{
    public class USUARIOS
    {
        ...
        public MODELO.USUARIO OBTENER_EMAIL(string EMAIL)
        {
            return CASOS_DE_USO.USUARIOS.GESTION_USUARIOS.OBTENER_EMAIL(EMAIL, oCONTEXTO);
        }

        public MODELO.USUARIO OBTENER_CLAVE(string CLAVE)
        {
            return CASOS_DE_USO.USUARIOS.GESTION_USUARIOS.OBTENER_CLAVE(CLAVE, oCONTEXTO);
        }
