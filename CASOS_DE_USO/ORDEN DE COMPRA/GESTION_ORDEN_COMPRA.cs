...
namespace CASOS_DE_USO.ORDEN_DE_COMPRA
{
    public class GESTION_ORDEN_COMPRA
    {
        ...
        {
            return AZMED_CLINICA.ORDENES_DE_COMPRAS.Include("PEDIDO").Include("COTIZACION").FirstOrDefault(_ => _.ID_ORDEN_COMPRA == CODIGO);
        }

        public static List<MODELO.ORDEN_COMPRA> OBTENER_ORDENES_COMPRAS(CONTEXTO.CLINICA_AZMED AZMED_CLINICA)
        {
            return AZMED_CLINICA.ORDENES_DE_COMPRAS.Include("PEDIDO").Include("COTIZACION").ToList();
        }
    }
}
