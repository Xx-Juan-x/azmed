...
namespace CASOS_DE_USO.TURNOS
{
    public class GESTION_TURNOS
    {
        ...
        {
            return AZMED_CLINICA.TURNOS.Include("PACIENTE").Include("PLAN").Include("OBRA_SOCIAL").Include("ESPECIALIDAD").Include("PROFESIONAL").FirstOrDefault(_ => _.ID_TURNO == CODIGO);
        }
